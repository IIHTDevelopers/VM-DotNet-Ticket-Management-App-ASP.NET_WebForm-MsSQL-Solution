...
namespace TicketManagementApp.Tests.TestCases
{
    public class FunctionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Ticket_NotNull()
        {
            //Arrange
            var res = false;
        ...
        [Fact]
        public async Task<bool> Testfor_GetAll_Ticket_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_UpdateTicket_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_AllTicket_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
